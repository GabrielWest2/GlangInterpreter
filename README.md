...
Glang is a custom programming language designed for fun and learning. This repository contains an interpreter for Glang and several example programs to demonstrate its capabilities.
